...
import com.cnc.my.spring.spring_tx.dao.AccountDao;
import com.cnc.my.spring.spring_tx.service.AccountService;
...
@Transactional(propagation = Propagation.REQUIRED, readOnly = false, timeout = -1, isolation = Isolation.DEFAULT, noRollbackFor = {ArithmeticException.class})
